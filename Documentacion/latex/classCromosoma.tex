...
\hypertarget{classCromosoma_ad9c66633c62ac96944faae7e778beb21}{\index{Cromosoma@{Cromosoma}!delete\-Clausula@{delete\-Clausula}}
\index{delete\-Clausula@{delete\-Clausula}!Cromosoma@{Cromosoma}}
\subsubsection[{delete\-Clausula}]{\setlength{\rightskip}{0pt plus 5cm}void Cromosoma\-::delete\-Clausula (
\begin{DoxyParamCaption}
\item[{int}]{x}
\end{DoxyParamCaption}
)}}\label{classCromosoma_ad9c66633c62ac96944faae7e778beb21}


get\-Numero\-Clausulas 

elimina la claúsula x del cromosoma y reduce en 1 el numero\-Clausulas 
\begin{DoxyParams}{Parámetros}
{\em x} & es un número entero que indica la claúsula a eliminar \\
\hline
\end{DoxyParams}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCromosoma_ad9c66633c62ac96944faae7e778beb21_icgraph}
\end{center}
\end{figure}


\hypertarget{classCromosoma_a845ebd5367a0e7978bf8d4b1ae452cbe}{\index{Cromosoma@{Cromosoma}!evaluar\-Cromosoma@{evaluar\-Cromosoma}}
\index{evaluar\-Cromosoma@{evaluar\-Cromosoma}!Cromosoma@{Cromosoma}}
\subsubsection[{evaluar\-Cromosoma}]{\setlength{\rightskip}{0pt plus 5cm}void Cromosoma\-::evaluar\-Cromosoma (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{classCromosoma_a845ebd5367a0e7978bf8d4b1ae452cbe}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCromosoma_a845ebd5367a0e7978bf8d4b1ae452cbe_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCromosoma_a59d6a42685e8b6e983b496d8051e4168_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCromosoma_a400e7970b9e2d9995cbc6b1f4335fd51_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCromosoma_a825104a1dd2a7595d119907c84fd2fd1_icgraph}
\end{center}
\end{figure}


\hypertarget{classCromosoma_a8a75eb52e417f9c050c32969b56984e7}{\index{Cromosoma@{Cromosoma}!obtener\-Salida@{obtener\-Salida}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCromosoma_aaf002d2f7f9438e74eeba52892868e83_icgraph}
\end{center}
\end{figure}
...
\hypertarget{classCromosoma_a826283527e3bdefe28a7ba7fc84dc965}{\index{Cromosoma@{Cromosoma}!set\-Clausula@{set\-Clausula}}
\index{set\-Clausula@{set\-Clausula}!Cromosoma@{Cromosoma}}
\subsubsection[{set\-Clausula}]{\setlength{\rightskip}{0pt plus 5cm}void Cromosoma\-::set\-Clausula (
\begin{DoxyParamCaption}
\item[{int}]{x, }
\item[{vector$<$ bool $>$}]{z}
\end{DoxyParamCaption}
)}}\label{classCromosoma_a826283527e3bdefe28a7ba7fc84dc965}
