...
\vspace*{0.5cm}
{\small Viernes, 29 de Junio de 2012 18:16:27}\\
\end{center}
\end{titlepage}
...
\input{structFuncionAptitud_1_1compare}
\input{classCromosoma}
\input{classCruce}
\input{classFuncionAptitud}
\input{classFuncionSeleccionCruce}
\input{classMutacion}
\input{classSeleccion}
\input{classTablaDeVerdad}
\printindex
\end{document}
